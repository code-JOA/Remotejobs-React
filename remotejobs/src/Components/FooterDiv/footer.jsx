        ...
        <span className='divTitle text-[18px] font-semibold pb-[1.5rem] text-white'>
         ...
         <div>
          ...
          <div className='icons flex gap-4 py-[1rem]'>
            <AiFillInstagram className='bg-white p-[18px] h-[35px] h-[35px] rounded-full icon
            text-blueColor'/>
            <BsFacebook className='bg-white p-[18px] h-[35px] h-[35px] rounded-full icon
            text-blueColor'/>
            <BsTwitter className='bg-white p-[18px] h-[35px] h-[35px] rounded-full icon
            text-blueColor'/>
          </div>
